...
*Start Time : 2023년 0월 29일 15시 14분 38초
...
*********************************************************************/
[10 20 40 50 60 100]
10 + 20 = 30 -> 10, 20 pop / 30 push
30(result) + 30 + 40 = 100 -> 30, 40 pop / 70 push
100(result) + 50 + 60 = 210 -> 50, 60 pop / 110 push
210(result) + 70 + 100 = 380 -> 100, 100 pop / 170 push
390(result) + 110 + 170 = 1030 -> 110, 170 pop : len(list) = 0
result = 660
'''
import sys, heapq
...
while len(decks) > 1:
    newDeck = heapq.heappop(decks) + heapq.heappop(decks)
    result += newDeck
    heapq.heappush(decks, newDeck)
